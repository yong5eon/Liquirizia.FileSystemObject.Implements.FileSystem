...
PKG = 'Liquirizia.FileSystemObject.Implements.FileSystem'
SRC = 'src'
EXCLUDES = []
DESC = 'Implementation FileSystemObject for FileSystem in Python Modernized Application Framework Liquirizia'
WHO = 'Heo Yongseon'
...
setup(
	...
	classifiers=[
		...
		'Application Framework :: Liquirizia :: FileSystemObject :: FileSystem',
	],
	install_requires=[
